...
import ChartOption from "../../components/instructor/Charts/ChartOption";

const PageDashboard = () => {
  const [open, setOpen] = useState(true);
  const [chartOneData] = useState({
    series: [
      {
        name: "Total Courses",
      ...
      {
        name: "Total Views",
        data: [20, 15, 30, 20, 25, 30, 45, 35, 55, 40, 25, 50],
      },
      {
        name: "Total Students",
        data: [15, 18, 25, 30, 28, 22, 33, 40, 50, 45, 30, 55],
      },
    ],
  });
  const [OptionData] = useState({
    ChartSalesData: [
      {
        name: "Total Sales",
        data: [55, 60, 50, 70, 45, 65, 75],
      },
    ],
    ChartViewsData: [
      {
        name: "Total Views",
        data: [50, 60, 55, 75, 50, 70, 80],
      },
    ],
    ChartCoursesData: [
      {
      ...
      <div className="m-3 text-xl text-gray-900 font-semibold">
        <>
          ...
          <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
            <ChartOne data={chartOneData.series} />
            <ChartOption data={OptionData} />
            <ChartThree />
          </div>
        </>
      </div>
