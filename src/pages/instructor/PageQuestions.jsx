...
const CoursesWithUsersQA = () => {
    ...
    const fetchCourses = async () => {
      try {
        const response = await fetch(
          `https://educoresystem.onrender.com/api/instructor/${userId}`,
          {
            method: "GET",
            headers: {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await fetch(
          `https://educoresystem.onrender.com/api/instructor/questions/${userId}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`, 
  ...
  const handleReplySubmit = async () => {
    ...
    try {
      await fetch("https://educoresystem.onrender.com/api/instructor/addAnswer", {
        method: "POST",
        headers: {
