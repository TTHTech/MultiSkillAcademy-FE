...
const PageCourseDetail = () => {
    ...
    const fetchCourseData = async () => {
      ...
      try {
        const response = await fetch(
          `https://educoresystem.onrender.com/api/instructor/courses/${id}`,
          {
            method: "GET",
            headers: {
  ...
  const handleAddSection = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://educoresystem.onrender.com/api/instructor/add-section",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSaveSection = async (section_id) => {
    ...
    try {
      // Gọi API cập nhật Section
      const response = await fetch(
        `https://educoresystem.onrender.com/api/instructor/update-section/${section_id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteSection = async (section_id) => {
    ...
    try {
      // Gọi API xóa Section
      const response = await fetch(
        `https://educoresystem.onrender.com/api/instructor/delete-section/${section_id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSaveLecture = async (lecture_id, section_id, lecture_Order) => {
    ...
    try {
      const response = await fetch(
        `https://educoresystem.onrender.com/api/instructor/update-lecture/${lecture_id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteLecture = async (section_id, lecture_id) => {
    ...
    try {
      const response = await fetch(
        `https://educoresystem.onrender.com/api/instructor/delete-lecture/${lecture_id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleAddLecture = async (section_id) => {
    ...
    try {
      const response = await fetch(
        "https://educoresystem.onrender.com/api/instructor/add-lecture",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleAddImage = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        const response = await fetch(
          `https://educoresystem.onrender.com/api/instructor/addImage/${course.courseId}`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleDeleteImage = async () => {
    ...
    try {
      const response = await fetch(
        `https://educoresystem.onrender.com/api/instructor/deleteImage/${course.courseId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleEditImage = async () => {
    ...
    if (newImageUrl) {
      ...
      try {
        const response = await fetch(
          `https://educoresystem.onrender.com/api/instructor/updateImage/${course.courseId}`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
