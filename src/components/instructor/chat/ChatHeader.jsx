...
const ChatHeader = ({ 
  ...
  return (
    <div className="bg-purple-500 p-4 flex items-center justify-between">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <span className="text-sm text-purple-50">{displayStatus}</span>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        ...
        <button className="p-2 text-white hover:bg-purple-600 rounded-full transition-colors">
