...
const ChatInput = ({ chatId, addMessage, setIsTyping, disabled }) => {
  ...
  // Handle send message for Instructor
  ...
  // Send typing status via WebSocket for Instructor
    ...
    <div className="border-t p-3 relative bg-white">
      ...
      <div className="flex items-center space-x-2">
        ...
        <input
          ...
          className="flex-1 border rounded-full py-2 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:bg-gray-100"
          value={message}
