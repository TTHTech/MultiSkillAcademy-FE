        ...
        <div className="p-8">
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="font-medium text-gray-600">
              ...
              {Math.min(indexOfLastItem, filteredScores.length)} của{" "}
              {filteredScores.length} kết quả
            </div>
          </div>
                  ...
                  currentItems.map((score) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-center">
                        <div
                          className={`inline-flex items-center justify-center w-10 py-1 px-2 text-sm font-medium rounded-full
                          ${
                            score.score >= 7
