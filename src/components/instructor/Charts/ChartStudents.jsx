    ...
    <div className="col-span-12 xl:col-span-4 rounded-lg border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="relative inline-block">
          ...
          >
            <option value="this-week" className="dark:bg-gray-800">This Week</option>
            <option value="last-week" className="dark:bg-gray-800">Last Week</option>
          </select>
