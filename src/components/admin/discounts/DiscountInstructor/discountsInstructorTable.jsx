    ...
    const fetchDiscounts = async () => {
      try {
        const response = await axios.get(
          `${baseUrl}/api/admin/discounts/instructor`,
          {
        ...
        <>
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-white mb-2">
              Quản lý mã giảm giá giảng viên
            </h2>
            <p className="text-gray-400 text-lg">
              Danh sách các mã giảm giá được tạo bởi giảng viên
            </p>
          </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-4 px-6 text-center">
                            <span
                              className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${getStatusStyle(discount.status)}`}
                            >
