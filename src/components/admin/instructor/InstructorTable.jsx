...
const InstructorsTable = () => {
    ...
    useEffect(() => {
        const fetchInstructors = async () => {
            try {
                ...
                const response = await fetch("https://educoresystem.onrender.com/api/admin/instructors", {
                    method: "GET",
                    headers: {
    ...
    const handleDelete = async (instructorId) => {
        ...
        if (confirmed) {
            try {
                const token = localStorage.getItem("token");
                const response = await fetch(`https://educoresystem.onrender.com/api/admin/instructors/${instructorId}`, {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://educoresystem.onrender.com/api/admin/instructors/${editingInstructor.id}`, {
                method: 'PUT',
                headers: {
