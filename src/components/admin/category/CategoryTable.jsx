...
const CategoryTable = () => {
  ...
  const handleDeleteCategory = async (categoryId) => {
    ...
    if (!confirmation) {
      setIsLoading(false); // Ngừng trạng thái loading nếu người dùng hủy
      return;
    }
    ...
    try {
      ...
      // Cập nhật danh sách category sau khi xóa
      setCategories(
  ...
  const handleCancelAction = () => {
    ...
    setShowAddCategoryForm(false); // Đóng form thêm mới
            ...
            <div className="bg-gray-700 p-4 rounded-lg">
              ...
              <div className="flex justify-between">
                ...
                <button
                  ...
                  onClick={handleCancelAction} // Gọi hàm hủy
                >
                  Cancel
                </button>
              </div>
