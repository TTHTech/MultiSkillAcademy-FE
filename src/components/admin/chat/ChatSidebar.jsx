...
const ChatSidebar = ({ onUserSelect, refreshTrigger }) => {
  ...
  // Fetch all users for frontend search
  ...
  const createIndividualChat = async (user) => {
    try {
      ...
      const request = {
        ...
        initialMessage: "Xin chào! Đây là Admin."
      };
  ...
  const createGroupChat = async () => {
    try {
      ...
      const request = {
        ...
        initialMessage: `Chào mừng mọi người! Nhóm "${groupName}" đã được tạo bởi Admin.`
      };
    ...
    <div className="w-[360px] bg-white border-r flex flex-col h-screen">
      ...
      <div className="p-4 flex items-center justify-between border-b">
        <div className="flex items-center gap-3">
          ...
          />
          <h2 className="text-xl font-bold">Trò chuyện Admin</h2>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <button
                      onClick={() => setParticipantFilter("INSTRUCTOR")}
                      className={`px-3 py-1 text-sm rounded-full transition-colors ${
                        participantFilter === "INSTRUCTOR"
                          ? "bg-emerald-500 text-white"
                          : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                      }`}
                    >
