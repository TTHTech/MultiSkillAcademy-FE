...
const RegisterForm = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      <div id="register-container" className="fade-in max-w-6xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl flex overflow-hidden z-10 border border-white/20">
        {/* Left side - Hero Section */}
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600/90 via-pink-600/90 to-indigo-600/90 p-12 relative">
          <div className="w-full flex flex-col justify-between">
            {/* Header */}
            <div>
              <div className="flex items-center mb-8">
                <FaRocket className="text-white text-4xl mr-3 animate-pulse" />
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 transform hover:translate-x-2 transition-transform duration-300">
                <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center flex-shrink-0">
                  <HiOutlineSparkles className="text-yellow-300 text-xl" />
                </div>
                <div>
                  <h3 className="text-white font-semibold mb-1">Học Tập Cá Nhân Hóa</h3>
                  <p className="text-white/80 text-sm">AI điều chỉnh lộ trình học phù hợp với bạn</p>
                </div>
              </div>

              <div className="flex items-start space-x-4 transform hover:translate-x-2 transition-transform duration-300">
                <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center flex-shrink-0">
                  <HiOutlineUserGroup className="text-green-300 text-xl" />
                </div>
                <div>
                  <h3 className="text-white font-semibold mb-1">Cộng Đồng Hỗ Trợ</h3>
                  <p className="text-white/80 text-sm">Kết nối với mentor và bạn học toàn cầu</p>
                </div>
              </div>

              <div className="flex items-start space-x-4 transform hover:translate-x-2 transition-transform duration-300">
                <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center flex-shrink-0">
                  <FaCertificate className="text-blue-300 text-xl" />
                </div>
                <div>
                  <h3 className="text-white font-semibold mb-1">Chứng Chỉ Uy Tín</h3>
                  <p className="text-white/80 text-sm">Được công nhận bởi các doanh nghiệp hàng đầu</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6 mt-8 pt-8 border-t border-white/20">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white text-sm">Bảo mật cao</span>
              </div>
              <div className="flex items-center space-x-2">
                <BsCheckCircleFill className="text-blue-400 text-xl" />
                <span className="text-white text-sm">Đăng ký miễn phí</span>
              </div>
              <div className="flex items-center space-x-2">
                <HiOutlineTrendingUp className="text-yellow-400 text-xl" />
                <span className="text-white text-sm">Cập nhật liên tục</span>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-10 left-10 w-32 h-32 bg-blue-400/30 rounded-full blur-3xl animate-pulse animation-delay-2000"></div>
        </div>
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12 bg-white">
          <div className="max-w-md mx-auto">
            ...
            <div className="lg:hidden flex items-center justify-center mb-8">
              <FaRocket className="text-purple-600 text-3xl mr-2" />
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Chỉ mất 30 giây để bắt đầu học tập</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-200 pr-11"
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 flex items-center justify-center space-x-2 transition-all duration-200 hover:border-gray-400 hover:shadow-md group"
                >
