...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://educoresystem.onrender.com/api/auth/login", {
        username,
        password,
      });
  ...
  const handleOAuthLogin = (provider) => {
    window.location.href = `https://educoresystem.onrender.com/oauth2/authorize/${provider}`;
  };
