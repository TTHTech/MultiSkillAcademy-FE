    ...
    const fetchCourses = async () => {
      try {
        const response = await axios.get(
          `${baseUrl}/api/student/promotion/top-15-courses`
        );
      ...
      <section className="py-12 px-6 bg-gradient-to-r from-purple-50 to-violet-50">
        <div className="max-w-[1500px] mx-auto flex justify-center items-center min-h-[400px]">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-gray-600">Đang tải khóa học có khuyến mãi tốt nhất</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-start gap-4">
            <Tag className="w-12 h-12 text-purple-500 mt-1" />
            <div>
              ...
              <p className="text-gray-700 mt-2 font-medium">
                Các khóa học được giảm giá tốt nhất của hệ thống
              </p>
            </div>
          </div>
...
export default TopCoursesWithPromotion;
