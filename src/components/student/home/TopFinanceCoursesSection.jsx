...
const TopFinanceCoursesSection = () => {
  ...
  const categoryId = "CAT003"; // Finance & Accounting category ID
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        setError("Không thể tải dữ liệu khóa học tài chính và kế toán.");
        console.error("Failed to fetch finance courses", err);
      } finally {
        setLoading(false);
      }
    };
      ...
      <section className="py-12 px-6 bg-gradient-to-r from-green-50 to-emerald-50">
        <div className="max-w-[1500px] mx-auto flex justify-center items-center min-h-[400px]">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-gray-600">Đang tải khóa học tài chính và kế toán...</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-start gap-4">
            <DollarSign className="w-12 h-12 text-green-600 mt-1" />
            <div>
              ...
              <p className="text-gray-700 mt-2 font-medium">
                Nắm vững các kỹ năng quản lý tài chính cá nhân, tài chính doanh nghiệp và kế toán
              </p>
            </div>
          </div>
...
export default TopFinanceCoursesSection;