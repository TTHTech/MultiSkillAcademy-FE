...
const TopDevelopmentCoursesSection = () => {
  ...
  const categoryId = "CAT001"; // Development category ID
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        setError("Không thể tải dữ liệu khóa học phát triển.");
        console.error("Failed to fetch development courses", err);
      } finally {
        setLoading(false);
      }
    };
      ...
      <section className="py-12 px-6 bg-gradient-to-r from-indigo-50 to-purple-50">
        <div className="max-w-[1500px] mx-auto flex justify-center items-center min-h-[400px]">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-gray-600">Đang tải khóa học phát triển...</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-start gap-4">
            <Globe className="w-12 h-12 text-indigo-600 mt-1" />
            <div>
              <h2 className="text-4xl font-extrabold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                Phát Triển & Lập Trình Web
              </h2>
              <p className="text-gray-700 mt-2 font-medium">
                Khám phá các khóa học phát triển từ các chuyên gia hàng đầu trong
                ngành
              </p>
            </div>
          </div>
...
export default TopDevelopmentCoursesSection;